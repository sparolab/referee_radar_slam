...
ros::Publisher pubLaserCloudLocal, pubLaserCloudGlobal, pubReferee;
...
int main(int argc, char *argv[]) {
    ...
    pubReferee = nh.advertise<yeti::CurrReferee>("referee", 100);
    ...
    std::string radardir = seq_dir;
    std::string datadir = radardir + "polar/";
    ...
    Eigen::MatrixXd targets, cart_targets1, cart_targets2, polar;
